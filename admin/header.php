            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <?php
                        $result = mysqli_query($con,"SELECT COUNT(1) FROM markers ORDER BY id ASC");
                    ...
                    <ul class="dropdown-menu">
                        <li class="header">You have <?php echo "$total";?> map-marks</li>
                        <li>
                            <!-- inner menu: contains the actual data -->


                        </li>
                        <li class="footer"><a href="report.php">See All map-marks</a></li>
                    </ul>
                </li>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="marker.php"><i class="fa fa-angle-double-right"></i> Map cordinates</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="report.php"><i class="fa fa-angle-double-right"></i> generate</a></li>
                    </ul>

                </li>
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-lock"></i> <span>My Profile</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
